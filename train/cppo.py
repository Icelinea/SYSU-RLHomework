...
def train(
    ...
    checkpoint_rel_path = "ray_results/transport/CPPO/MultiPPOTrainer_transport_0a97f_00000_0_2024-12-30_12-32-13/checkpoint_000088"
        ...
        config={
            ...
            "evaluation_config": {
                ...
                "callbacks": MultiCallbacks(
                    [
                        # TrainingUtils.RenderingCallbacks, # moviepy bugs
